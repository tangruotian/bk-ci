...
CREATE TABLE IF NOT EXISTS `T_TEMPLATE` (
  ...
  `SCOPE_TYPE` varchar(32) CHARACTER SET utf8mb4 NULL COMMENT '模板范围类型',
  `STATUS` varchar(32) CHARACTER SET utf8mb4 NULL COMMENT '模板状态',
  `TEMPLATE_YAML` mediumtext CHARACTER SET utf8mb4 NULL COMMENT 'YAML 模板',
  `DESC` varchar(1024) CHARACTER SET utf8mb4 NULL COMMENT '描述',
  PRIMARY KEY (`VERSION`),
